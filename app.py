...
Original file is located at
    https://colab.research.google.com/drive/1gO9chfpHuLWW256--H_LrhpDBsATIktV
...
Edad = st.slider('Edad', min_value=14, max_value=52, value=20, step=1)  # la barrta es un slider se pude variar
